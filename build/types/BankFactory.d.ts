...
interface BankFactoryInterface extends ethers.utils.Interface {
  functions: {
    "bankImplementation()": FunctionFragment;
    "createBank(string)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "bankImplementation",
    values?: undefined
  ): string;
  encodeFunctionData(functionFragment: "createBank", values: [string]): string;
  encodeFunctionData(
...
export class BankFactory extends Contract {
  ...
  functions: {
    bankImplementation(overrides?: CallOverrides): Promise<{
      0: string;
    }>;
  ...
  bankImplementation(overrides?: CallOverrides): Promise<string>;

  "bankImplementation()"(overrides?: CallOverrides): Promise<string>;

  createBank(name: string, overrides?: Overrides): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    createBank(name: string, overrides?: CallOverrides): Promise<string>;
  ...
  estimateGas: {
    bankImplementation(overrides?: CallOverrides): Promise<BigNumber>;

    "bankImplementation()"(overrides?: CallOverrides): Promise<BigNumber>;

    createBank(name: string, overrides?: Overrides): Promise<BigNumber>;
